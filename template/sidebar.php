          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown active">
             <?php if ($_SESSION['level'] =="admin") { ?>
              ...
              <li><a class="nav-link" href="../data-kelas/read.php"><i class="far fa-square"></i> <span>DATA SISWA</span></a></li>
            ...
            <li class="dropdown">
              <a href="../logout.php" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i> <span>Layout</span></a>
              <ul class="dropdown-menu">
